...
!function ($, moment) {
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            this.cb = function () { };
            this.noEnd = options.noEnd || false;
            this.endStr = "无期限";
        ...
        updateFormInputs: function () {
            ...
            if(this.noEnd && this.activeNoEnd){
                this.container.find('input[name=daterangepicker_end]').val(this.endStr);
            }else{
        ...
        move: function () {
            ...
            if(this.bottom){
                 this.container.css({
                    top: this.element.offset().top + this.element.outerHeight() - parentOffset.top-310,
                    left: this.element.offset().left - parentOffset.left,
                    right: 'auto'
                });
                if (this.container.offset().left + this.container.outerWidth() > $(window).width()) {
                ...
                this.container.removeClass("opensright").addClass("opensbottom");
            }
        },
        ...
        updateInputText: function() {
            if (this.element.is('input') && !this.singleDatePicker) {
                if(this.noEnd && this.activeNoEnd){
                    this.element.val(this.startDate.format(this.format) + this.separator + this.endStr);
                }else{
        ...
        clickDate: function (e) {
            ...
            var col = title.substr(3, 1);
            var cal = $(e.target).parents('.calendar');
            this.activeNoEnd = $(e.target).hasClass('active');
